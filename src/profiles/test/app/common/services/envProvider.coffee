...
class Environment
	...
	apiUrl: '' # blank because all api calls will be faked
...
class EnvironmentProvider
	...
	[
		'$httpBackend'
		'$log'
		'ambiHome.services.harcodedDataSvc'
...
mod = angular.module(modName, ['ngMockE2E', 'ambiHome.services.harcodedDataSvc'])
